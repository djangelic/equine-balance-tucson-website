...
const Blog = () => {
  ...
  return (
    <section id="blog" className="py-20 bg-sage-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {blogPosts.map((post, index) => (
            <article key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <button className="flex items-center text-sage hover:text-sage-dark font-medium transition-colors duration-200">
                  Read More
        ...
        <div className="text-center">
          <div className="bg-white rounded-lg p-8 max-w-2xl mx-auto">
            <Book className="text-sage mx-auto mb-4" size={48} />
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-2 border border-sage rounded-lg focus:outline-none focus:ring-2 focus:ring-sage"
              />
              <button className="bg-sage hover:bg-sage-dark text-white px-6 py-2 rounded-lg font-medium transition-colors duration-200">
                Subscribe
              </button>
            </div>
          </div>
